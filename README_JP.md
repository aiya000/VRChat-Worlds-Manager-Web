...
ゲームの上に小さく浮かべておくと、いまいるワールドを離れずにアプリへ手が届きます。
アプリからワールドを開くと自分あてに招待が届き、VRChatの通知からそのワールドへ入ります。
Androidでは、リンクからアプリのインスタンスへ直接入る方法がないため、この経路になります。

|                                                                                  |                                                                              |
| -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| ![VRChatの上に浮かぶアプリ](docs/screenshots/android-1-floating-over-vrchat.jpg) | ![浮かんでいるアプリの位置](docs/screenshots/android-2-where-the-app-is.jpg) |
| **1.** ワールドにいるあいだ、アプリを上に浮かべておきます                        | **2.** この丸いものがアプリです                                              |
| ![届いた招待](docs/screenshots/android-3-self-invite-arrives.jpg)                | ![ワールドへ移動中](docs/screenshots/android-4-traveling-to-the-world.jpg)   |
| **3.** アプリからワールドを開くと、自分あてに招待が届きます                      | **4.** 招待を受けると、そのワールドへ移動します                              |

> スクリーンショットは追加予定です。デスクトップの一覧、VRオーバーレイの中、スマートフォンの画面。
